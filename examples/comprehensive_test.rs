...
fn main() {
    ...
    let tests = vec![
        ...
        ("world", "hello world", Some((6, 11)), "Literal match mid-text"),
        ...
        // Boundaries
        (r"\bhello", "hello world", Some((0, 5)), "Word boundary start"),
        (r"world\b", "hello world", Some((6, 11)), "Word boundary end"),
        ...
        ("(http|https)://", "https://example.com", Some((0, 8)), "Protocol alternation"),
        ...
        // Complex patterns
        (r"\d{3}-\d{4}", "Call 555-1234 now", Some((5, 13)), "Phone number"),
        (r"\b\w+@\w+\.\w+", "Email: user@example.com!", Some((7, 23)), "Email pattern"),
